...
async def on_guild_join(guild):
    ...
    await haupt.send("Danke das ihr mich hier haben wollt")
...
async def on_member_join(member):
    ...
    haupt = client.get_channel(386868636163244033)
    await haupt.send("Danke das du hier bist bitte lese die Regeln")

@client.event
async def on_member_remove(member):

    haupt = client.get_channel(386868636163244033)
    await haupt.send("Schade das er gegangen ist")
